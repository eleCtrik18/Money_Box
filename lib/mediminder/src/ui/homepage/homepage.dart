...
import 'package:money_box/mediminder/src/ui/medicine_details/bill_details.dart';
import 'package:money_box/mediminder/src/ui/new_entry/new_entry.dart';
      ...
      builder: (context, snapshot) {
        if (!snapshot.hasData) {
          ...
          return Container(
            ...
            child: Center(
              child: Text(
                "Hurray! You have no Bills to pay",
